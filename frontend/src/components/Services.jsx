            ...
            <div className="col-md-4">
              <div class="card p-3">
                <div class="card-body text-center">
                  ...
                  <h5 class="card-title mb-3 fs-4 fw-bold">Studying Together</h5>
            ...
            <div className="col-md-4">
              <div class="card p-3">
                <div class="card-body text-center">
                  ...
                  <h5 class="card-title mb-3 fs-4 fw-bold">Solo Studying</h5>
                  <p class="card-text lead">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  </p>
            ...
            <div className="col-md-4">
              <div class="card p-3">
                <div class="card-body text-center">
                  ...
                  <h5 class="card-title mb-3 fs-4 fw-bold">To be Star Programer</h5>
                  <p class="card-text lead">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
                  </p>
